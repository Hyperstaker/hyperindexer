export const HyperstakerAbi = [
  {
    type: "constructor",
    inputs: [
      { name: "_hypercertMinter", type: "address", internalType: "address" },
      { name: "_baseHypercertId", type: "uint256", internalType: "uint256" },
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct Hyperstaker.Stake",
        components: [
  ...
  },
  {
    ...
    outputs: [
      { name: "isClaimed", type: "bool", internalType: "bool" },
      { name: "stakingStartTime", type: "uint256", internalType: "uint256" },
    ],
    stateMutability: "view",
  },
  {
  ...
  { type: "error", name: "ExpectedPause", inputs: [] },
  {
    ...
    inputs: [
      { name: "actualRewardAmount", type: "uint256", internalType: "uint256" },
      {
  ...
  { type: "error", name: "NoRewardAvailable", inputs: [] },
  { type: "error", name: "NoUnitsInHypercert", inputs: [] },
  { type: "error", name: "NotBaseType", inputs: [] },
  { type: "error", name: "NotStaked", inputs: [] },
  { type: "error", name: "RewardTransferFailed", inputs: [] },
  {
    type: "error",
    name: "WrongBaseHypercert",
    inputs: [
      { name: "baseHypercertId", type: "uint256", internalType: "uint256" },
      {
        name: "expectedBaseHypercertId",
        type: "uint256",
        internalType: "uint256",
      },
    ],
